...
module.exports = {
  ...
  module: {
    loaders: [
      ...
      { test: /\.css$/, loader: 'style!css?modules&importLoaders=2&sourceMap&localIdentName=[name]_[local]__[hash:base64:5]!postcss?browsers=last 2 version&outputStyle=expanded&sourceMap' },
